    ...
    return(
        <Modal>
            <section className="w-full flex flex-col">
                ...
                <h3 className="text-white place-self-center text-3xl pt-8">Log In</h3>
                <form  className="self-center w-full lg:w-7/12" autoComplete="off">
                    <fieldset className="flex flex-col">
                        ...
                        <input type="text" id="username" className="p-3 rounded-lg" placeholder="Enter your username."/>

                        <label htmlFor="password" className="text-white text-lg p-2 ">Password</label>
                        <input type="password" id="password" className="p-3 rounded-lg" placeholder="Enter your password."/>
                    </fieldset>
                    <section>
